...
class NetworkTopo( Topo ):
    def build( self, **_opts ):
        ...
        self.addLink(sw4, hub1, intfName2='hu1-eth1', params2={ 'ip' : '192.168.3.1/29' })
        self.addLink(sw4, hub2, intfName2='hu2-eth1', params2={ 'ip' : '192.168.3.2/29' })
        self.addLink(sw4, hub3, intfName2='hu3-eth1', params2={ 'ip' : '192.168.3.3/29' })
        self.addLink(sw5, spoke1, intfName2='sp1-eth0', params2={ 'ip' : '192.168.1.10/24' })
        self.addLink(sw6, spoke2, intfName2='sp2-eth0', params2={ 'ip' : '192.168.1.11/24' })
        self.addLink(sw1, hub1,  intfName2='hu1-eth0', params2={ 'ip' : '192.168.1.1/24'}) #/24?? ,
        self.addLink(sw1, spoke1, intfName2='sp1-eth1', params2={ 'ip' : '192.168.1.4/24'} ) #/24??? 192.168.3.4?? ,
        self.addLink(sw2, hub2,  intfName2='hu2-eth0', params2={ 'ip' : '192.168.1.2/24'}) #/24?? ,
        self.addLink(sw2, spoke2, intfName2='sp2-eth1', params2={ 'ip' : '192.168.1.5/24'} )
        self.addLink(sw3, hub3,  intfName2='hu3-eth0', params2={ 'ip' : '192.168.1.3/24'}) #/24?? ,
        self.addLink(sw3, spoke3, intfName2='sp3-eth1', params2={ 'ip' : '192.168.1.6/24'} )

        h1 = self.addHost( 'h1', ip='192.168.1.100/24',
                            defaultRoute='via 192.168.1.10' )
        self.addLink(h1, sw1)
        h2 = self.addHost( 'h2', ip='192.168.1.101/24',
                            defaultRoute='via 192.168.1.11' )
        self.addLink(h2, sw2)
...
def run():
    ...
    #info( net[ 'hub1' ].cmd( 'ifconfig hu1-eth0 192.168.1.1 netmask 255.255.255.0'))
    info( net[ 'sp1' ].cmd( 'ifconfig sp1-eth0 192.168.1.10 netmask 255.255.255.0' ) )
    info( net[ 'sp1' ].cmd( 'ifconfig sp2-eth0 192.168.1.11 netmask 255.255.255.0' ) )
    info( net[ 'sp2' ].cmd( 'ifconfig sp2-eth1 192.168.1.5 netmask 255.255.255.0' ) )
    #info( net[ 'hub2' ].cmd( 'ifconfig hu2-eth0 192.168.1.2 netmask 255.255.255.0'))

    info( net[ 'sp3' ].cmd( 'ifconfig sp3-eth1 192.168.1.6 netmask 255.255.255.0' ) )
    #info( net[ 'hub3' ].cmd( 'ifconfig hu3-eth0 192.168.1.3 netmask 255.255.255.0'))
    ...
    info( net[ 'h2' ].cmd( '/sbin/ethtool -K h1-eth0 rx off tx off sg off' ) )
    info( net[ 'h2' ].cmd( 'ifconfig h1-eth0 mtu 1400' ) )
    ...
    net['sp2'].cmd('ip route add 192.168.3.0/29 via 192.168.1.2 dev sp2-eth1') #So SP1 can ping HU2
    net['sp3'].cmd('ip route add 192.168.3.0/29 via 192.168.1.3 dev sp3-eth1') #So SP1 can ping HU3
